...
<?php include "header_nav_footer/nav.php" ;?>
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><i class="fa fa-cog" aria-hidden="true"></i> Post <small>Manager your Posts</small></h1>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                   <div class="list-group">
                        ...
                        <div
                            ...
                            <a href="post.php" class="list-group-item-action main-active"><i class="fa fa-pen"
